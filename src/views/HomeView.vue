  ...
  <DashboardLayout>
    <div>
      ...
      <WhiteCard :customClass="'mt-[20px]'">
        ...
        <div
          class="pt-[37px] px-[24px] md:pr-[171px] pb-[54px] ssm:pl-[48px] flex justify-between md:items-center md:flex-row flex-col gap-[22px] md:gap-[100px] lg:gap-[150px] xl:gap-[236px]">
